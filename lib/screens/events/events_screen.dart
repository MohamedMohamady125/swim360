...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: #f0f3f6; /* Very light gray/blue background */
        ...
        .page-active {
            ...
            pointer-events: auto;
            position: relative; /* Set active view back to relative positioning */
        }
        
        .nav-item.active {
            color: #1e40af; /* Darker blue active color */
            font-weight: 600;
        }
        .nav-item.active svg {
            stroke: #1e40af;
        ...
        /* Search Bar & Filter Button Styling */
        .top-controls {
            display: grid;
