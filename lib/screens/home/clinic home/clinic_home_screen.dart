...
<body class="text-gray-800">
    ...
    <script>
        ...
        function renderHomeView() {
            ...
            const mockRole = localStorage.getItem('selectedRole') || 'clinic'; // Testing Clinic
            ...
            return `
                <div class="p-4 md:p-8">
                    ...
                    <!-- Core Action Cards (Matching Image Style) --><div class="grid grid-cols-2 gap-3 mb-8">
                        ...
                        <!-- My Services (Replaced My Clients) -->
                         <button class="action-card p-4 text-center" onclick="showSnackbar('Navigating to My Services...', false)">
                        ...
                        <!-- Manual Booking -->
                         <button class="action-card p-4 text-center" onclick="showSnackbar('Navigating to Manual Booking Tool...', false)">
